...
class instala_db {
	...
	***********************/
	function __construct() {
		...
		//Tabela com os Recursos transferidos
		$wpdb->query("CREATE TABLE IF NOT EXISTS colonization_imperio_transfere_recurso (
		id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
		id_imperio_origem INT(6) NOT NULL,
		nome_npc VARCHAR(255) DEFAULT '',
		id_imperio_destino INT(6) NOT NULL,
		...
		//Tabela com os logs de recursos
		$wpdb->query("CREATE TABLE IF NOT EXISTS colonization_log_recursos_imperio (
		id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
		id_imperio INT(6) DEFAULT 0,
		id_recurso INT(6) NOT NULL,
		qtd INT(6) NOT NULL,
		...
		$wpdb->query("CREATE TABLE IF NOT EXISTS colonization_modelo_naves (
		id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
		id_imperio INT(6) DEFAULT 0,
		...
		$wpdb->query("DELIMITER $$
		CREATE TRIGGER atualiza_tech
		AFTER UPDATE
		ON colonization_imperio_techs FOR EACH ROW
		BEGIN
		DELETE FROM colonization_balancos_turno WHERE id_imperio = new.id_imperio AND turno=new.turno;
		DELETE FROM colonization_lista_colonias_turno WHERE id_imperio = new.id_imperio AND turno=new.turno;
		END$$
