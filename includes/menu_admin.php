	...
	******************/
	function colonization_admin_instalacoes() {
		...
		if (isset($_GET['id'])) {
			...
			<thead>
			<tr><th>ID</th><th>Nome</th><th>Descrição</th><th>Tech Requisito</th><th style='width: 40px;'>Slots</th style='width: 80px;'><th>Autônoma</th><th style='width: 120px;'>Desguarnecida</th><th style='width: 60px;'>Oculta</th><th>Especiais</th><th>Ícone</th><th>Custos</th><th>&nbsp;</th>
			</tr>
			</thead>
			<tbody>";
	...
	function colonization_admin_colonias() {
		...
		if (isset($_GET['id'])) {
			...
			foreach ($lista_id as $id) {
				...
				<thead>
				<tr><th>ID</th>{$imperios_npcs}<th>Planeta</th><th style='width: 80px;'>Capital</th><th style='width: 100px;'>População</th><th style='width: 100px;'>Poluição</th><th>Turno</th><th>&nbsp;</th>
				</tr>
				</thead>
				<tbody>";
