...
class frota 
{
	...
	function __construct($id) {
		...
		blindagem, escudos, poder_invasao, especiais, HP, qtd, turno
	...
	***********************/
	function lista_dados() {
		...
		$html = "<td>
			...
			<div data-atributo='nome' data-editavel='true' data-valor-original='{$this->nome}' data-style='width: 80px;'>{$this->nome}</div>
			<div></div>
			</td>
			<td><div data-atributo='tipo' data-editavel='true' data-valor-original='{$this->tipo}' data-style='width: 60px;'>{$this->tipo}</div></td>
	...
	/***********************
	function lista_frota()
	----------------------
	Exibe toda a frota de um Império
	***********************/
	function lista_frota($id_imperio) {
