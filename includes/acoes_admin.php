...
class acao_admin
{
	...
	***********************/
	function lista_dados() {
		...
		<td><div data-atributo='lista_recursos' data-editavel='true' data-style='width: 120px;' data-valor-original='{$this->lista_recursos}'>{$this->lista_recursos}</div></td>
		<td><div data-atributo='qtd' data-editavel='true' data-style='width: 120px;' data-valor-original='{$this->qtd}'>{$this->qtd}</div></td>
