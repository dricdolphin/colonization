...
function nova_nave(evento, id_imperio) {
	...
	camuflagem.innerHTML = "<td><div data-atributo='camuflagem' data-editavel='true' data-valor-original='' data-style='width: 50px;'><input type='text' data-atributo='camuflagem' data-ajax='true' style='width: 50px;'></input></div></td>";
